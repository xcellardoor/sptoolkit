...
//sql statement
$sql = "INSERT INTO templates (name, description) VALUES ('Quick start - Charles Schwab security update','An email supposedly from Schwab.com requesting the target to update their security information.  When the link is clicked the target will be presented with an inline educational page about malware.')";
mysql_query($sql) or die(mysql_error());
