...
$sql = "INSERT INTO templates (name, description) VALUES ('[QS] Schwab security update','An email supposedly from Schwab.com requesting the target to update their security information.  When the link is clicked the target will be presented with an inline educational page about malware.  [Video requires Internet access to YouTube]')";
mysql_query($sql) or die(mysql_error());
