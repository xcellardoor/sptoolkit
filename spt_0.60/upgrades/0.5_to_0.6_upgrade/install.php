...
//quick start campaign 2 (Schwab.com)
...
//sql statements
$sql = "INSERT INTO templates (id,name, description) VALUES ('$id','Charles Schwab fake security update request','This quick start campaign template is ready to go. It contains an email supposedly from Schwab.com requesting the target to update their security information.  When the link is clicked the target will be presented with an inline educational page about malware.')";
mysql_query($sql) or die(mysql_error());
