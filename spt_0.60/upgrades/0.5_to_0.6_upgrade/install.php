...
$sql = "INSERT INTO templates (name, description) VALUES ('[QS] Schwab security update','An email from Schwab.com requesting the target to update their security information.  When the link is clicked, automatic education about malware will occur using an embedded YouTube video.  [Video requires Internet access to YouTube]')";
mysql_query($sql) or die(mysql_error());
