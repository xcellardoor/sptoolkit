...
//Ensure all upgraded files were successfully copied over their replacements
    ...
    array_push($failures, checkVersion("dashboard/index.php", "22.0"));
...
//remaining sql statements
    $sql = "INSERT INTO templates (name, description) VALUES ('[QST02 v0.70] Schwab security update','An email from Schwab.com requesting the target to update their security information.  [Email template only, no web site]')";
    mysql_query($sql) or die(mysql_error());
